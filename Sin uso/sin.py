...
''')
    ...
    if opcion_escogida == '1':
        ...
        productos.append({'nombre': nombre_producto, 'precio': precio_producto, 'cantidad': cantidad_producto,
                          '% Dcto': descuento_producto_si, 'descuento': descuento, 'total': total_producto})
        ...
        ******************** Ticket de Compra ************************''')
        ...
        for producto in productos:
            print(f"{producto['nombre']:<15} | {producto['precio']:<10} | {producto['cantidad']:<10} | {producto['% Dcto']:<10} | {producto['descuento']:<10} | {producto['total']:<10}")
